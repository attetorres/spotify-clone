<script setup>
import { ref, toRefs, onMounted, toRef } from "vue";
...
<template>
  <li
    class="flex intems-center justify-between rounded-md hover:bg-[#2A2929]"
  ...
  >
    ...
    <div class="flex items-center">
      <button class="mr-5" type="button" v-if="isHover">
